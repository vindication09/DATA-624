...
Lets start with the most simple: Removing predictors
The overall percentage of data missing per variable is less than the 25 threshold to alltogether drop variables. Lets see what the relationship between variables is through correlation.   
